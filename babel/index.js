...
if (process.argv.findIndex(function (item) {
  ...
  _fs["default"].writeFileSync("".concat(_path["default"].resolve(out), "/index.py"), (0, _python["default"])(parse).code, "utf8");
  ...
  if (process.argv.findIndex(function (item) {
    ...
    _fs["default"].writeFileSync(_path["default"].resolve("".concat(_path["default"].resolve(out), "/build.json")), parse ? JSON.stringify(parse) : "{}", 'utf8');
  }
} else {
